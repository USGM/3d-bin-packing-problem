...
def intersect(item1, item2):
    ...
    return (
        rect_intersect(item1, item2, Axis.LENGTH, Axis.HEIGHT)
        and rect_intersect(item1, item2, Axis.HEIGHT, Axis.WIDTH)  # xz dimension
        and rect_intersect(item1, item2, Axis.LENGTH, Axis.WIDTH)  # yz dimension
    )  # xy dimension
